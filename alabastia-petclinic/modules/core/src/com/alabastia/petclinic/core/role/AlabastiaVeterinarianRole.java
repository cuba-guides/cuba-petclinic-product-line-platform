...
import com.haulmont.sample.petclinic.core.role.VeterinarianRole;
...
public class AlabastiaVeterinarianRole extends VeterinarianRole {
    ...
    @EntityAccess(entityClass = TreatmentRoom.class, operations = {EntityOp.CREATE, EntityOp.READ, EntityOp.UPDATE, EntityOp.DELETE})
    @EntityAccess(entityClass = DefaultTreatmentRoom.class, operations = {EntityOp.CREATE, EntityOp.READ, EntityOp.UPDATE, EntityOp.DELETE})
    @Override
    ...
    @EntityAttributeAccess(entityClass = TreatmentRoom.class, modify = "*")
    @EntityAttributeAccess(entityClass = DefaultTreatmentRoom.class, modify = "*")
    @Override
